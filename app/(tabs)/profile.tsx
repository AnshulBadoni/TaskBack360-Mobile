            ...
            <View className="items-center pt-8 pb-6 px-6">
               <View className="relative mb-5">
                  <View className="w-28 h-28 rounded-full border border-gray-200 p-0.5 bg-white shadow-sm">
                     <Image source={{ uri: 'https://cdni.pornpics.de/1280/7/818/89675401/89675401_002_8428.jpg    ' }} className="w-full h-full rounded-full" />
                  </View>
                  <View className="absolute bottom-1 right-1 w-5 h-5 bg-green-500 border-2 border-white rounded-full" />
               </View>
               <View className="items-center">
                  <Text className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight text-center">Anshul Badoni</Text>
