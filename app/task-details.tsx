            ...
            <View className="flex-row flex-wrap bg-slate-200 border-y border-slate-200">
               <View className="w-[50%] bg-white p-3 border-r border-b border-slate-100">
                  ...
                  <View className="flex-row items-center">
                     ...
                     <Text className="text-sm font-medium">Anshul Badoni</Text>
                  </View>
               </View>
               ...
               <View className="space-y-6">
                  <View className="flex-row">
                     ...
                     <View className="flex-1 pt-1">
                        <Text className="text-xs text-slate-500"><Text className="font-semibold text-slate-700">Anshul Badoni</Text> changed status to <Text className="text-primary font-bold">In Progress</Text></Text>
