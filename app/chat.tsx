    ...
    <SafeAreaView className="flex-1 bg-white">
        ...
        <View className="flex-row items-center p-4 pb-2 justify-between">
          <View className="flex-row items-center flex-1">
             ...
             <View className="flex-col">
                <Text className="text-slate-900 text-lg font-bold leading-tight">Alex Rivera</Text>
      ...
      <ScrollView className="flex-1 p-4" showsVerticalScrollIndicator={false}>
         ...
         <View className="flex-row items-end mb-6 max-w-[85%]">
            ...
            <View className="flex-col">
               <Text className="text-slate-500 text-[12px] font-medium ml-1 mb-1">Alex Rivera</Text>
